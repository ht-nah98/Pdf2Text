...
class PdfProcessor:
    ...
    def process_structure(self, image_path):
        ...
        # Split the cleaned madori_test_data into three lists: left_column, middle_column, and right_column
        left_column = []
        middle_column = []
        right_column = []
        ...
        footer_lines = [line for line in all_columns if line['type'] == 'footer']
        sorted_result = [line for line in all_columns if line['type'] != 'footer'] + footer_lines
